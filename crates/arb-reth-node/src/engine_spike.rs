...
/// Minimal [`PayloadValidator`] for [`crate::ArbNode`]. Used only to satisfy the engine-tree
...
mod tests {
    ...
    use crate::engine::{produce, wait_for_head};
    ...
    async fn drive_replay(factory: TestFactory, chain_id: u64) {
        ...
        let payload_builder: PayloadBuilderHandle<crate::ArbPayloadTypes> =
