...
- `--share-sparse-trie-with-payload-builder <true|false>` lets Reth compute the state root
  concurrently with ArbOS execution. It defaults to `true`; pass `false` for A/B testing.
